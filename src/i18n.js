...
export const text = fa ? {
  ...
  readyTitle: 'بازی تای فایتر', readyDescription: 'ایکس‌وینگ‌ها را شکار کن و از لیزرهای قرمزشان جاخالی بده. با صفر شدن سلامت بدنه یا فرار سه ایکس‌وینگ، گشت تمام می‌شود.',
  ...
  debrief: (score, kills) => `${kills} جنگندهٔ شورشی نابود شد. ${score} امتیاز. دوباره پرواز کن.`,
  ready: 'منتظر خلبان', playing: 'گشت فعال', paused: 'گشت متوقف', over: 'پایان مأموریت',
  bonus: 'ای‌وینگ ویژه: ۲۰۰ امتیاز؛ فرارش جریمه ندارد.',
  ...
  readyTitle: 'TIE Fighter game', readyDescription: 'Hunt X-wings and dodge their red lasers. Zero hull or three escaped X-wings end the patrol.',
  ...
  debrief: (score, kills) => `${kills} Rebel ships destroyed. ${score} points. Take another flight.`,
  ready: 'Awaiting pilot', playing: 'Patrol active', paused: 'Patrol paused', over: 'Sector lost',
  bonus: 'Bonus A-wing: 200 points · Safe to miss.',
