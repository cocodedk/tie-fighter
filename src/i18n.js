...
export const text = fa ? {
  name: 'تای فایتر', subtitle: 'گشت فضایی', score: 'امتیاز', best: 'رکورد', hull: 'بدنه', escapes: 'گریخته‌ها',
  readyTitle: 'بازی تای فایتر', readyDescription: 'ایکس‌وینگ‌ها را شکار کن و از لیزرهای قرمزشان جاخالی بده. سه اصابت یا فرار سه دشمن، پایان گشت است.',
  ...
  name: 'TIE Fighter', subtitle: 'Sector patrol', score: 'Score', best: 'Best', hull: 'Hull', escapes: 'Escapes',
  readyTitle: 'TIE Fighter game', readyDescription: 'Hunt the X-wings. Dodge their red lasers. Three hits or three escapes end your patrol.',
