...
export async function registerWebMCP() {
  ...
  const tools = [
    {
      name: 'get_game_state',
      description: 'Read selected shipType, cannonCount, activeLasers, mode, score, runKills, enemy type/points/escapePenalty, best score, career kills, rank, medals, honors, hull health, kills until full repair, escapes, incoming laser positions and velocities, '
