...
export const careerText = language === 'fa' ? {
  ...
  commander: 'فرمانده', darthVader: 'دارث ویدر', firstVictory: 'نخستین پیروزی',
  ...
  campaign: (kills) => `کارزار فعلی: ${kills} از ۲۵۰ شکار`,
  ...
  commander: 'Commander', darthVader: 'Darth Vader', firstVictory: 'First Victory',
  ...
  campaign: (kills) => `Current campaign: ${kills} / 250 kills`,
